import { Material, Vector2, Object3D, BufferGeometry, Skeleton } from 'three';
...
declare type GlbSource = string | string[] | Blob | undefined | null;
export declare const getStoryAssetPath: (publicAsset: string) => string;
export declare const isValidGlbFormat: (source: GlbSource) => boolean;
 ...
 */
export declare const normaliseMaterialsConfig: (materials: Record<string, Material>) => void;
 ...
 */
export declare const mutatePose: (targetNodes?: {
    [name: string]: Object3D<import("three").Event>;
} | undefined, sourceNodes?: {
    [name: string]: Object3D<import("three").Event>;
} | undefined) => void;
export declare const useEmotion: (nodes: ObjectMap['nodes'], emotion?: Emotion | undefined) => void;
...
export declare const triggerCallback: (callback?: (() => void) | undefined) => void;
export {};
