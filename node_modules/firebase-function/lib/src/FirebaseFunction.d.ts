...
export type FirebaseFunctionType<FFunctionType extends FunctionType<unknown, ValidReturnType, unknown>> = new (data: Record<PropertyKey, unknown> & {
    databaseType: DatabaseType;
}, auth: AuthData | undefined, logger: ILogger) => FirebaseFunction<FFunctionType>;
...
export declare namespace FirebaseFunction {
    ...
    function create<FFunctionType extends FunctionType<unknown, ValidReturnType, unknown>>(FirebaseFunction: FirebaseFunctionType<FFunctionType>, getPrivateKeys: (databaseType: DatabaseType) => PrivateKeys): functions.HttpsFunction & functions.Runnable<unknown>;
}
export declare function executeFunction<FFunctionType extends FunctionType<unknown, ValidReturnType, unknown>>(firebaseFunction: FirebaseFunction<FFunctionType>): Promise<FirebaseFunction.Result<FunctionType.ReturnType<FFunctionType>>>;
/**
 ...
 */
export declare function mapReturnTypeToResult<T>(promise: Promise<T>): Promise<FirebaseFunction.Result<T>>;
