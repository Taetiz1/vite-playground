...
import {
  RoundedBoxGeometry,
  mergeVertices
} from "./chunk-ERP2F7LS.js";
import {
  useFrame
} from "./chunk-X4SWGDHO.js";
import {
  BoxGeometry,
  BufferAttribute,
  BufferGeometry,
  ...
  SphereGeometry,
  Vector3
} from "./chunk-LG472MHF.js";
import "./chunk-KBUAZBQ3.js";
import {
  require_react
} from "./chunk-D2CW5DLW.js";
import {
  __commonJS,
  __toESM
...
// node_modules/@micmania1/react-three-rapier/dist/micmania1-react-three-rapier.esm.js
...
var importRapier = async () => {
  let r = await import("./rapier.es-ZFYEDGFS.js");
  await r.init();
  return r;
};
var Physics = ({
  ...
  const [isPaused, setIsPaused] = (0, import_react.useState)(_paused);
...
var geometryFromCollider = (collider) => {
  switch (collider.shape.type) {
    ...
    case kA.ConvexPolyhedron: {
      const cv = collider.shape.vertices;
...
var DebugShape = (0, import_react.memo)(({
  colliderHandle,
  color,
  sleepColor
}) => {
  ...
  const ref = (0, import_react.useRef)(null);
  const [material] = (0, import_react.useState)(new MeshBasicMaterial({
    color,
    wireframe: true
  }));
  useFrame(() => {
  ...
  return import_react.default.createElement("mesh", {
    ref,
    material
  }, import_react.default.createElement("primitive", {
    object: geometry,
    attach: "geometry"
  }));
});
var Debug = ({
  ...
  const [colliders, setColliders] = (0, import_react.useState)([]);
  ...
  return import_react.default.createElement("group", null, colliders.map((handle) => import_react.default.createElement(DebugShape, {
    key: handle,
...
//# sourceMappingURL=@micmania1_react-three-rapier.js.map
